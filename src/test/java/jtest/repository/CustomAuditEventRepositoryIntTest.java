package jtest.repository;

import jtest.JtestApp;
import jtest.config.Constants;
import jtest.config.audit.AuditEventConverter;
import jtest.domain.PersistentAuditEvent;
...
import static jtest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
